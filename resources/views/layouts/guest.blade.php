...
<body x-data="{ 'loaded': true }">
    ...
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            ...
            <div class="relative hidden h-full w-full items-center bg-brand-950 lg:grid lg:w-1/2">
                <div class="z-1 flex items-center justify-center w-full">
                    ...
                    <div class="flex max-w-md flex-col items-center space-y-8 px-6">
                        <a href="{{ route('dashboard') }}" class="block">
                            <img src="{{ asset('images/logo/logo.png') }}" alt="{{ config('app.name', 'Fit Nation') }}" width="200" height="200" class="h-28 w-28 rounded-full" />
                        </a>
                        <div class="space-y-3 text-center">
                            <h1 class="font-display text-4xl font-semibold tracking-tight text-white">
                                {{ config('app.name', 'Fit Nation') }}
                            </h1>
                            <p class="text-sm text-brand-200">
                                Personalized workout plans and set-by-set tracking.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="fixed right-6 bottom-6 z-50">
                <button
                    class="inline-flex size-14 bg-brand-500 hover:bg-brand-600 items-center justify-center rounded-full text-white transition-colors"
